...
public class Detector : RoleBase, IHideAndSeekRole
{
    ...
    public override CustomRoles RoleId => CustomRoles.Detector;

    public override void SetupCustomOption()
    {
        Options.SetupRoleOptions(69_211_601, TabGroup.CrewmateRoles, CustomRoles.Detector, CustomGamemodes.HideAndSeek);
