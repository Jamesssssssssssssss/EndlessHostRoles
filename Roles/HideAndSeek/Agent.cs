...
public class Agent : RoleBase, IHideAndSeekRole
{
    ...
    public override CustomRoles RoleId => CustomRoles.Agent;

    public override void SetupCustomOption()
    {
        Options.SetupRoleOptions(69_211_2001, TabGroup.ImpostorRoles, CustomRoles.Agent, CustomGamemodes.HideAndSeek);
